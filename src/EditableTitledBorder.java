 ...
 * Defaults Table:
 * <ul>
 * <li>&quot;EditableTitledBorder.border&quot;
 * <li>&quot;EditableTitledBorder.font&quot;
 * <li>&quot;EditableTitledBorder.titleColor&quot;
 * </ul>
 * <p>
...
public class EditableTitledBorder extends AbstractBorder
{
    ...
    /**
     * Creates a EditableTitledBorder instance.
     *
     * @param title  the title the border should display
     */
    public EditableTitledBorder(String title) {
        this(null, title, LEADING, DEFAULT_POSITION, null, null);
    }

    /**
     * Creates a EditableTitledBorder instance with the specified border
     * and an empty title.
     *
     * @param border  the border
     */
    public EditableTitledBorder(Border border) {
     ...
     * @param title  the title the border should display
     */
    public EditableTitledBorder(Border border, String title) {
    ...
    public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
        ...
        if ((title != null) && !title.isEmpty()) {
            int edge = (border instanceof EditableTitledBorder) ? 0 : EDGE_SPACING;
    ...
    public Border getBorder() {
        return border != null
                ? border
                : UIManager.getBorder("EditableTitledBorder.border");
    }
    ...
    public Font getTitleFont() {
        return titleFont == null ? UIManager.getFont("EditableTitledBorder.font") : titleFont;
    }
    ...
    public Color getTitleColor() {
        return titleColor == null ? UIManager.getColor("EditableTitledBorder.titleColor") : titleColor;
    }
    ...
    public Component.BaselineResizeBehavior getBaselineResizeBehavior(
        ...
        switch (getPosition()) {
            case EditableTitledBorder.ABOVE_TOP:
            case EditableTitledBorder.TOP:
            case EditableTitledBorder.BELOW_TOP:
                return Component.BaselineResizeBehavior.CONSTANT_ASCENT;
            case EditableTitledBorder.ABOVE_BOTTOM:
            case EditableTitledBorder.BOTTOM:
            case EditableTitledBorder.BELOW_BOTTOM:
    ...
    private int getPosition() {
        ...
        Object value = UIManager.get("EditableTitledBorder.position");
