 ...
 * StudiamFactory.java
 *
 * Arbitraryish class that contains lots of useful methods for creating different visual
 * components with a consistent style and to save space in other classes and avoid redundancy
 *
 * @version 09/17/18
 */
